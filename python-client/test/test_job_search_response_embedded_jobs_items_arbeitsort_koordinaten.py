...
class TestJobSearchResponseEmbeddedJobsItemsArbeitsortKoordinaten(unittest.TestCase):
    """JobSearchResponseEmbeddedJobsItemsArbeitsortKoordinaten unit test stubs"""
    ...
    def testJobSearchResponseEmbeddedJobsItemsArbeitsortKoordinaten(self):
        """Test JobSearchResponseEmbeddedJobsItemsArbeitsortKoordinaten"""
        # FIXME: construct object with mandatory attributes with example values
        # model = JobSearchResponseEmbeddedJobsItemsArbeitsortKoordinaten()  # noqa: E501
        pass
