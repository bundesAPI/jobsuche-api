...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.pc_v4_jobdetails_refnr_get_endpoint = _Endpoint(
            settings={
                "response_type": (JobDetails,),
                "auth": ["APIKeyHeaders"],
                "endpoint_path": "/pc/v4/jobdetails/{refnr}",
                "operation_id": "pc_v4_jobdetails_refnr_get",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def pc_v4_jobdetails_refnr_get(self, refnr, **kwargs):
        """Job Details  # noqa: E501

        Detaillierte Informationen zu einem Stellenangebot abrufen  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pc_v4_jobdetails_refnr_get(refnr, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        kwargs["refnr"] = refnr
        return self.pc_v4_jobdetails_refnr_get_endpoint.call_with_http_info(**kwargs)
