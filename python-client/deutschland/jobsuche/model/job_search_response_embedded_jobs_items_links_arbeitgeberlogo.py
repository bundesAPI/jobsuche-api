...
class JobSearchResponseEmbeddedJobsItemsLinksArbeitgeberlogo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JobSearchResponseEmbeddedJobsItemsLinksArbeitgeberlogo - a model defined in OpenAPI
