...
class JobSearchResponseEmbeddedJobsItemsArbeitsortKoordinaten(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JobSearchResponseEmbeddedJobsItemsArbeitsortKoordinaten - a model defined in OpenAPI
