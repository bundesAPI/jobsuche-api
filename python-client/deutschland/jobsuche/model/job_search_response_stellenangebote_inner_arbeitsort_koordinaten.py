...
class JobSearchResponseStellenangeboteInnerArbeitsortKoordinaten(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """JobSearchResponseStellenangeboteInnerArbeitsortKoordinaten - a model defined in OpenAPI
